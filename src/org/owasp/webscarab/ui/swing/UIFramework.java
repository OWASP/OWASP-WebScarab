...
public class UIFramework extends JFrame implements FrameworkUI {
    ...
    public void run() {
        sessionDialog.setSize(400,240);
        sessionDialog.getRootPane().setDefaultButton(okButton);
        sessionDialog.show();
        synchronized(_exit) {
            try {
                _exit.wait();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        sessionDialog = new javax.swing.JDialog();
        tempRadioButton = new javax.swing.JRadioButton();
        ...
        sessionButtonGroup = new javax.swing.ButtonGroup();
        ...
        sessionDialog.getContentPane().setLayout(new java.awt.GridBagLayout());

        sessionDialog.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        sessionDialog.setTitle("Session options");
        sessionDialog.setLocationRelativeTo(null);
        sessionDialog.setModal(true);
        sessionDialog.setResizable(false);
        tempRadioButton.setMnemonic('T');
        tempRadioButton.setSelected(true);
        tempRadioButton.setText("Create a temporary session (deleted on exit)");
        sessionButtonGroup.add(tempRadioButton);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        sessionDialog.getContentPane().add(tempRadioButton, gridBagConstraints);

        newRadioButton.setMnemonic('N');
        newRadioButton.setText("Create a New session (persistent)");
        sessionButtonGroup.add(newRadioButton);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        sessionDialog.getContentPane().add(newRadioButton, gridBagConstraints);

        openRadioButton.setMnemonic('E');
        openRadioButton.setText("Open an existing session");
        sessionButtonGroup.add(openRadioButton);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        sessionDialog.getContentPane().add(openRadioButton, gridBagConstraints);

        jLabel1.setText("Previous sessions :");
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        sessionDialog.getContentPane().add(jLabel1, gridBagConstraints);
        ...
        sessionDialog.getContentPane().add(jScrollPane2, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        gridBagConstraints.weightx = 1.0;
        sessionDialog.getContentPane().add(okButton, gridBagConstraints);
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (tempRadioButton.isSelected()) {
            ...
            createNewSession();
        } else if (openRadioButton.isSelected()) {
            openExistingSession();
        }
            ...
            new SwingWorker() {
                public Object construct() {
                    try {
                        ...
                        _framework.setSession("FileSystem", _tempDir, "");
                ...
                public void finished() {
                    ...
                    if (result instanceof StoreException) {
                        ...
                        JOptionPane.showMessageDialog(null, new String[] {"Error creating a temporary session : ", se.getMessage()}, "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }.start();
        }
    ...
    private javax.swing.ButtonGroup sessionButtonGroup;
    private javax.swing.JDialog sessionDialog;
    ...
    private javax.swing.JRadioButton tempRadioButton;
