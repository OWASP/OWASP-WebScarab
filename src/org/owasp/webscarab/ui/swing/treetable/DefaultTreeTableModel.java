...
package org.owasp.webscarab.ui.swing.treetable;
...
/**
 * A simple treetable data model that uses TreeNodes. Most of this code is
 * ripped directly from DefaultTreeModel, since this implementation
 * merely displays the tree in a single column. Subclass the getColumnCount
 * and getValueAt methods to change this behaviour
 * <p>
...
public class DefaultTreeTableModel extends AbstractTreeTableModel {
    ...
    /**
      * Creates a treetable in which any node can have children.
      *
    ...
    /**
      * Creates a treetable specifying whether any node can have children,
