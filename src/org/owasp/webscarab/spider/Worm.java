...
class Worm 
	extends Thread 
{
	Crawler _crawler; // crawler in charge of this worm
	int _i; // index of this worm in crawler.worms[]
	boolean _dead; // true if this worm has been killed
	Link _link;
	...
	public void die () {
		_dead = true;
	// TODO implement proper threading mechanism
	//        stop ();
	}
}
