...
/** 
 * Storage of basic predicates of a page.
 * 
 * @since 0.poc
	...
	extends java.io.Serializable
{
	...
	/**
	 * Determines whether some action has to be taken encountering a given page.
	 * @param page an encountered page to classify
	 * @return true if further action is needed to process the page
	 */
