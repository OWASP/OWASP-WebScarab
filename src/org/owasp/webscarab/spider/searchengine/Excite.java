	...
	implements SearchEngine 
{
	...
	static MatchBox patResult = new TagExp( "<FONT COLOR=navy><B>(?{score})</B></FONT>" // score
	+ "<B>(?{link}<a>(?{title})</a>)</B>" // title and main link
	+ "<BR><B><I></I></B>" // URL
	+ "<BR><B><I></I></B>(?{description})" // Summary
	+ "<BR><B><I></I></B><a><p></a>" // More Like This
	);
	static MatchBox patMoreLink = new TagExp( "<INPUT TYPE=submit NAME=next VALUE=\"Next Results\">" );
