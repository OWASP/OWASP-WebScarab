...
/** 
 * Timer that is wrapped around a Crawler.
 * It times out the Crawler if alarm()ed.
 * 
 * @since 0.poc
...
class CrawlTimer 
	extends Timer 
{
	/** the Crawler this CrawlTimer is attached to */
	public final Crawler _crawler;
	
	/**
	 * Creates a Timer attached to a Crawler.
	 * @param crawler the Crawler this CrawlTimer is attached to
	 */
	public CrawlTimer ( Crawler crawler ) {
		_crawler = crawler;
	}

	/** Times out the attached Crawler. */
