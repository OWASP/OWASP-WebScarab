/* Generated By:JJTree: Do not edit this line. NodeArgumentList.java */
 ...
 * @author <AUTHOR>
 */
public class NodeArgumentList 
  extends SimpleNode 
{
  
  public NodeArgumentList ( int id ) {
    super( id );
  }
  
  public NodeArgumentList ( JavaOneDotTwo p, int id ) {
    super( p, id );
  }
