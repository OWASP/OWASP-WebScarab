/* Generated By:JJTree: Do not edit this line. NodeDoStatement.java */
 ...
 * @author <AUTHOR>
 */
public class NodeDoStatement 
  extends SimpleNode 
{
  
  public NodeDoStatement ( int id ) {
    super( id );
  }
  
  public NodeDoStatement ( JavaOneDotTwo p, int id ) {
    super( p, id );
  }
