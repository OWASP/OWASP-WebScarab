/* Generated By:JJTree: Do not edit this line. NodeNullLiteral.java */
 ...
 * @author <AUTHOR>
 */
public class NodeNullLiteral 
  extends SimpleNode 
{
  
  public NodeNullLiteral ( int id ) {
    super( id );
  }
  
  public NodeNullLiteral ( JavaOneDotTwo p, int id ) {
    super( p, id );
  }
