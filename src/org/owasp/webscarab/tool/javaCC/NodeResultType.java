/* Generated By:JJTree: Do not edit this line. NodeResultType.java */
 ...
 * @author <AUTHOR>
 */
public class NodeResultType 
  extends SimpleNode 
{
  
  public NodeResultType ( int id ) {
    super( id );
  }
  
  public NodeResultType ( JavaOneDotTwo p, int id ) {
    super( p, id );
  }
