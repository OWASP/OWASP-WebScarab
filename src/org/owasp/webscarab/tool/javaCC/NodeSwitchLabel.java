/* Generated By:JJTree: Do not edit this line. NodeSwitchLabel.java */
 ...
 * @author <AUTHOR>
 */
public class NodeSwitchLabel 
  extends SimpleNode 
{
  
  public NodeSwitchLabel ( int id ) {
    super( id );
  }
  
  public NodeSwitchLabel ( JavaOneDotTwo p, int id ) {
    super( p, id );
  }
