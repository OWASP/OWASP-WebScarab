/* Generated By:JJTree: Do not edit this line. NodeForStatement.java */
 ...
 * @author <AUTHOR>
 */
public class NodeForStatement 
  extends SimpleNode 
{
  
  public NodeForStatement ( int id ) {
    super( id );
  }
  
  public NodeForStatement ( JavaOneDotTwo p, int id ) {
    super( p, id );
  }
