/* Generated By:JJTree: Do not edit this line. NodeClassBody.java */
 ...
 * @author <AUTHOR>
 */
public class NodeClassBody 
  extends SimpleNode 
{
  
  public NodeClassBody ( int id ) {
    super( id );
  }
  
  public NodeClassBody ( JavaOneDotTwo p, int id ) {
    super( p, id );
  }
