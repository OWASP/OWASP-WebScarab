...
public class SSLKeyManager implements X509KeyManager {
    ...
    public synchronized String addPKCS12KeyStore(String filename, char[] keyStorePassword, char[] keyPassword) throws KeyStoreException, UnrecoverableKeyException, IOException, CertificateException {
        try {
            KeyStore ks = KeyStore.getInstance("PKCS12");
            ks.load(new FileInputStream(filename), keyStorePassword);
            String description = "PKCS#12: " + filename;
            addKeyStore(description, ks, keyPassword);
            return description;
